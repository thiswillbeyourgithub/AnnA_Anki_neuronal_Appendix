...
## FAQ
* **How does it work? (Layman version)** [Magic](https://en.wikipedia.org/wiki/BERT_(language_model)).
...
## TODO
* add an example of similarity between two cards to explain the concept
